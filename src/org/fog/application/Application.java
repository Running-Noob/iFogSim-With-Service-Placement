...
public class Application {
    ...
    // 一个AppLoop实例就代表一个应用程序完整走完一圈，数据所经过的模块
    // 一个Application可能有多个AppLoop
    private List<AppLoop> loops;

    // Map<边所传输的数据类型(或者说任务类型)TupleType, 应用程序边>
    ...
    public void addAppModule(String moduleName, int ram) {
        ...
        // AppModule继承自Vm，这里猜测是为了方便，因为AppModule如果要执行，本身就有一系列的配置需求
